// edit of the standard gioui colorpicker,
// except the text editor background is hardcoded for some reason,
// so I had to change it to fit my theme

package obxcolorpicker
			...
			return inset.Layout(gtx, func(gtx C) D {
				return layout.Stack{}.Layout(gtx,
					layout.Expanded(func(gtx C) D {
						return rectAbs(gtx, gtx.Constraints.Min.X, gtx.Constraints.Min.Y, theme.Surface0Color)
					}),
